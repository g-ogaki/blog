...
- The homepage terminal's three decorative, noninteractive macOS traffic-light circles are the sole exception to the chromatic palette: use the familiar red, amber, and green in title-bar order. They communicate window chrome rather than site actions or status, so never reuse these colors for controls, feedback, taxonomy, or content decoration.
