/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: e0b6fa4bca64cb069fc76016a63da7c9)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	CHAT_RATE_LIMITER: RateLimit;
	BLOG_HELPER: AiSearchInstance;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_WEBHOOK_URL" | "TURNSTILE_SECRET_KEY" | "IP_HASH_SECRET">> {}
}
